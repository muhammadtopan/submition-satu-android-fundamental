...
public class ReadAllActvity extends AppCompatActivity {
    ...
    public void getData(){
        ...
        AndroidNetworking.get("http://192.168.43.159/crud_java/read_all.php")
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        // do anything with response
                        {
                            ...
                            try {
                                ...
                                ListMahasiswaAdapter adapter = new ListMahasiswaAdapter(dataMahasiswa);
